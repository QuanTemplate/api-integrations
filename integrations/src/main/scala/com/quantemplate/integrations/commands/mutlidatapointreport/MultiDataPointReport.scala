...
import com.quantemplate.integrations.capitaliq.CapitalIQ.Mnemonic.*
import com.quantemplate.integrations.qt.QTService

class MultiDataPointReport(capitalIqService: CapitalIQService, qtService: QTService)(using
    ExecutionContext
):
